...
public class GameLogicService {
    ...
    // ============================================================
    //  阶段标记 — Phase 3：提升出牌验证准确性并优化性能缓存
    //  负责：出牌校验链（canBeat/isValidHand/等级牌判定）、
    //  牌型大小比较、炸弹优先级规则、逢人配万能牌匹配、
    //  CARD_TYPE_CACHE 等高频路径缓存命中验证
    //
    //  子任务：
    //   [ ] 出牌校验链重构（GameReferee → GameAlgorithm 双路径）
    //   [ ] CARD_TYPE_CACHE 缓存在出牌验证场景的命中率统计
    //   [ ] 级牌等级 getGameLevel 在出牌比大小中的正确性验证
    //   [ ] 逢人配万能牌在 canBeat 中的降级与匹配策略
    //   [ ] 炸弹压制关系：同点数炸弹按张数/出牌顺序
    // ============================================================

    // ============================================================
    //  阶段标记 — 提升开局稳定性：GameLogicService 发牌与状态管理
    //  负责：房间创建/加入/离开、发牌（含AI补位）、回合切换、
    //  出牌验证、游戏结束判定与升级计算
    // ============================================================
}
